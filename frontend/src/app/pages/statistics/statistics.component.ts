...
updateProgress()
{
  ...
  this.todayProgress.caloriesMax = this.breakfast.calories + this.lunch.calories + this.dinner.calories;
  this.todayProgress.proteinMax = this.breakfast.protein + this.lunch.protein + this.dinner.protein;
  this.todayProgress.fatsMax = this.breakfast.fats + this.lunch.fats+ this.dinner.fats;
  this.todayProgress.carbsMax = this.breakfast.carbs + this.lunch.carbs + this.dinner.carbs;
}
